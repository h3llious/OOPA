create database BanHang
	GO
use BanHang --Use QuanLyBanHang Database--
	GO
...
(
	...
	BillCustumerName nvarchar(100) not null,
	BillStaff int not null,--Mã nhân viên tính tiền--
	BillDate date not null,
	BillPrice float not null,
	FOREIGN KEY (BillStaff) REFERENCES dbo.StaffInfo(StaffID),--Mã nhân viên tính tiền bắt buộc phải tồn tại trong StaffID-
)
	Go
------------------------------------------------------
